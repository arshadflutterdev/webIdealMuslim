class SunanAnNasaiHadithDetails {
  int? status;
  String? message;
  Hadiths? hadiths;

  SunanAnNasaiHadithDetails({this.status, this.message, this.hadiths});

  SunanAnNasaiHadithDetails.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    hadiths = json['hadiths'] != null
        ? new Hadiths.fromJson(json['hadiths'])
        : null;
  }
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    chapter = json['chapter'] != null
        ? new Chapter.fromJson(json['chapter'])
        : null;
  }
