class SunanAnNasaiChapterModel {
  int? status;
  String? message;
  List<Chapters>? chapters;

  SunanAnNasaiChapterModel({this.status, this.message, this.chapters});

  SunanAnNasaiChapterModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
